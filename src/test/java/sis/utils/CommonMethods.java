...
public class CommonMethods extends PageInitializer {
	...
	/**
	 * This method clears the text-box first, then sets it text
	 * 
	 * @param element
	 * @param text
	 */
...
//--------------------------------------------TakesScreenshot------------------------------------------------//
	...
	public static byte[] takeScreenshot(String fileName) {
		...
		//////////////////////////////////
		//create a file and store in computer
	...
	/**
	 * This method iterates list of elements finds it and clicks it
	 * @param list
	 * @param value
	 */
